...
def test_merge_agents():
    ...
    dd = element_merge_agent(
        func=general_function, in_streams=[x,u], out_stream=t, name='dd', f=np.mean)
    ...
    asynch_merge(in_streams=[x,y], out_stream=z)
    mix_z = mix([x,y])
    compute_engine.execute_single_step()
    ...
    #----------------------------------------------------
    # Test element_merge_agent with StreamArray
    #----------------------------------------------------
    x = StreamArray('x')
    y = StreamArray('y')
    ...
    element_merge_agent(func=lambda v: v, in_streams=[x,y], out_stream=z)
    element_merge_agent(func=np.mean, in_streams=[x,y], out_stream=a)
    ...
    #----------------------------------------------------
    # Test blend_agent with StreamArray
    #----------------------------------------------------
    x = StreamArray('x')
    y = StreamArray('y')
    z = StreamArray('z')
    ...
    blend_agent(func=double, in_streams=[x, y], out_stream=z)
    blend_agent(func=double_add, in_streams=[x, y], out_stream=a, addend=10.0)
    ...
    #----------------------------------------------------
    # Test asynch_merge with StreamArray
    #----------------------------------------------------

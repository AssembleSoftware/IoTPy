...
def zip_stream(in_streams):
    ...
    merge_element(lambda v: v, in_streams, out_stream)
    return out_stream


def zip_map(func, in_streams, state=None, *args, **kwargs):
    """
    ...
    """
    out_stream = Stream('output of zip')
    merge_element(func, in_streams, out_stream,
                        state, *args, **kwargs)
    return out_stream
...
def mix(in_streams):
    ...
    merge_asynch(lambda v: v, in_streams, out_stream)
    return out_stream

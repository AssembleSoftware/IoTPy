'''
Taken from https://github.com/HamishWoodrow/anomaly_detection
'''
...
class anom_detect():
    ...
    def plot(self,left_marker, right_marker, data_label=None,left=None,right=None,bottom=None,top=None):
        ...
        ax1.axvline(x=left_marker)
        ax1.axvline(x=right_marker)
    ...
    def evaluate(self,data,anom_detect=True):
        ...
        if anom_detect:
            ...
            anoma_points = pd.DataFrame(df[0].iloc[outliers_index].sort_index())
